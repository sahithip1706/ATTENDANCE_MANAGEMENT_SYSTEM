...
class AttendanceApp:
    def __init__(self, root):
        ...
        self.students = []  # will be loaded from DB
    ...
    def load_students(self):
        ...
        self.students = [f"{sid} - {name}" for sid, name in rows]
    ...
    def save_new_student(self):
        ...
        self.cursor.execute("INSERT INTO students (student_id, name) VALUES (?, ?)", (sid, name))
        self.conn.commit()
        self.load_students()
